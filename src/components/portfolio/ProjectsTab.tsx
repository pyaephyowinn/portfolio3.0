...
const projects = [
  {
    title: "Minimax Visualizer",
    description: "Interactive TicTacToe game that visualizes the MiniMax algorithm with alpha-beta pruning in real-time.",
    tags: ["TypeScript", "Algorithm", "AI"],
    rarity: "epic" as const,
    link: "https://minimax-visualizer.vercel.app/",
    type: "Personal",
  },
  {
    title: "MM Trails",
